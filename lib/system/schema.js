module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = '𝐞𝐯𝐢𝐥'
      if (!('sk_author' in setting)) setting.sk_author = '𝐛𝐨𝐭'
      ...
      if (!('msg' in setting)) setting.msg = 'Hi +tag This is Evil Bot, A simple whatsapp bot by SpikeInc.'
      if (!isNumber(setting.style)) setting.style = 4
      if (!('cover' in setting)) setting.cover = 'https://graph.org/file/52c08efd6e1b52aed069c.jpg'
      ...
      global.db.setting = {
         ...
         msg: 'Hi +tag This is Evil Bot, A simple whatsapp bot by SpikeInc.',
         style: 4,
         cover: 'https://graph.org/file/52c08efd6e1b52aed069c.jpg',
