module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('msg' in setting)) setting.msg = 'Hi +tag 🪸\nI am an automated system (Genius Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Source* : https://github.com/mohalicious/moon-bot.'
      if (!isNumber(setting.style)) setting.style = 2
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/ac86d72d706b38a4f8be2.jpg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/DB0jUKrezufIDNLxta4V3B'
   } else {
      global.db.setting = {
         autodownload: true,
         debug: false,
         ...
         msg: 'Hi +tag 🪸\nI am an automated system (Genius Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Source* : https://github.com/mohalicious/moon-bot.',
         style: 2,
         cover: 'https://telegra.ph/file/ac86d72d706b38a4f8be2.jpg',
         link: 'https://chat.whatsapp.com/DB0jUKrezufIDNLxta4V3B'
      }
   }
}